...
public class SimpleAlarmAnalysis {
	...
	public static void main(String[] args) throws Exception {
		...
		RMQSource<String> btsdatasource= new RMQSource<String>(
		...
		DataStream<String> alerts = btsdatastream.flatMap(new BTSParser())
		...
		env.execute("Flink Application Analytic");
	}
    ...
    extends ProcessWindowFunction<BTSAlarmEvent, String, String, TimeWindow> {
		...
		@Override
  		public void process(String station_id,
					...
					int count = 0;
					for (Iterator<BTSAlarmEvent> iterator = records.iterator(); iterator.hasNext();) {
						BTSAlarmEvent btsrecord = iterator.next();
						count++;
					}
